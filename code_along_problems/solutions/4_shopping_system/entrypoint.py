...
# =================================================================================================
from helpers.core import save_store_info
...
def go_buy_products(shopping_list: dict) -> Tuple[dict, float]:
    ...
    # =============================================================================================
    # TODO 2: Read the store info JSON file by calling the `read_store_info` function
    ...
    # =============================================================================================
    print("--------------------------------------------")
    print("The items in the stores inventory are:")
    ...
    # (1 line) [slide 39].
    # =============================================================================================
    inventory = inventory_list_to_dict(inventory)
    ...
    for product_name in shopping_list:
        quantity_wanted = shopping_list[product_name]
        ...
        # [PSUEDO CODE 1 (PC 1)]: If the product name (TODO 8) is in inventory (TODO 7)
        # (1 line) [slide 13]
        if product_name in inventory:
            ...
            on_hand = inventory[product_name]["on_hand"] # Look in the store_info.json file
            cost_per_unit = inventory[product_name]["cost_per_unit"]
            ...
            max_amount_purchasable = min([quantity_wanted, on_hand])

            # [PSUEDO CODE 4] if the smallest value (PC 3) is not equal to 0 (1 line) [slide 13]
            if max_amount_purchasable != 0: # max_amount_purchasable > 0
                ...
                # (1-2 lines)
                billable_amount += cost_per_unit * max_amount_purchasable
                ...
                items_purchased[product_name] = max_amount_purchasable
                ...
                inventory[product_name]["on_hand"] = on_hand - max_amount_purchasable
    ...
    # =============================================================================================
    inventory = inventory_dict_to_list(inventory)
    ...
    # (1 line) [Something like `store_info['inventory'] = TODO_10`]
    # =============================================================================================
    store_info['inventory'] = inventory
...
def inventory_dict_to_list(inventory: dict) -> list:
    inventory_list = list()
